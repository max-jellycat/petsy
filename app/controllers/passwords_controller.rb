class PasswordsController < ApplicationController
  ...
  def create
    ...
    if @user
      ...
      redirect_to new_session_path, success: 'An email has been sent. Click in the link within to recover your password'
    else
      redirect_to new_password_path, danger: 'Email not found'
    end
  end
  ...
  def update
    ...
    if @user.recover_password === user_params[:recover_password]
      ...
      if @user.valid?
        ...
        redirect_to profile_path, success: 'Your password has been updated'
      else
        render :edit
      end
    else
